...
fk_aval_cpf varchar(14),
fk_aval_id_prod int,
avaliacao int,
CONSTRAINT fk_aval_cpf FOREIGN KEY(fk_aval_cpf) REFERENCES usuarios (cpf),
CONSTRAINT fk_aval_id_prod FOREIGN KEY(fk_aval_id_prod) REFERENCES produtos (id_produto)
);
...
('123.456.789-98', 1, 'maca.jpg', 'Maça Argentina', '04/12/19', '04/09/19', '3.00', 3),
('856.951.321-22', 1, 'laranja1.jpg', 'Laranja Bahia', '07/11/19', '07/09/19', '1.40', 3),
('856.951.321-22', 2, 'laranja1.jpg', 'Laranja Lima', '06/11/19', '10/08/19', '1.45', 3),
('856.951.321-22', 1, 'laranja1.jpg', 'Laranja Vermelha', '10/11/19', '15/09/19', '1.50', 3),
('856.951.321-22', 2, 'laranja1.jpg', 'Laranja Bahia', '07/11/19', '03/09/19', '1.50', 3),
('856.951.321-22', 1, 'laranja1.jpg', 'Laranja Lima', '06/11/19', '08/09/19', '1.50', 3),
('856.951.321-22', 1, 'laranja1.jpg', 'Laranja Seleta', '10/11/19', '25/09/19', '1.30', 3),
('123.456.951-10', 1, 'iogurte.jpg', 'Iogurte Nestle', '14/03/19', '26/09/19', '2.40', 4);

INSERT INTO suporte (desc_suporte, fk_cpf_sup) values
('problema no software', '123.456.789-98');


insert into avaliacao(fk_aval_cpf, fk_aval_id_prod, avaliacao) values('123.456.789-98', 1, 1);