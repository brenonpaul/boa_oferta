...
<div class="container">
	...
	<div class="row d-flex justify-content-center">
		<div class="col-6 bg-white">
			...
			<p style="font-size: 125%; text-indent:2em;" class="text-justify">
				...
				supermercado cadastrados por outros usuários, descobrindo onde encontrar o melhor
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <p style="font-size: 125%;" class="text-justify">
      	<strong>Seu Perfil:</strong> Página onde permite o usuário ver as informações de sua conta, podendo editá-las se desejar, assim como também mostra todas as postagens efetuadas pelo mesmo, sendo possível também alterar informações sobre os produtos cadastradas..
      </p>
    </div>
  </div>
