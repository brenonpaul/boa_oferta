...
$sql = "insert into produtos (foto_produto, nome_produto, data_visu, data_cadastro, preco, fk_id_mercado, fk_id_categoria, fk_cpf) values ('$foto_produto', '$nome_produto $marca_produto', '$data_visu', '$data_cadastro', $preco, (select id_mercado from mercados where nome_mercado = '$mercado'), (select id_categoria from categorias where nome_categoria = '$categoria'), (select cpf from usuarios where email = '$_SESSION[usuario]'));";
