...
if (!isset($_SESSION['usuario']) or $_GET['info'] <1 or $_GET['info'] >4) {
        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    ...
                    <div class="box">
                        <form action="../backend/infoPessoal.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                    <?php
                    if($_GET['info'] == 1) {
                    ?>
