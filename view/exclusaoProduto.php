    ...
    <div class="hero-body">
      <div class="container has-text-centered">
        <div class="column is-4 is-offset-4">
          ...
          <div class="box">
            <a href="../backend/excluirProduto.php?id=<?php echo($_GET['id']); ?>">
              <button type="submit" class="button is-block is-danger is-large is-fullwidth">Excluir</button>
            </a>
            <a href="seuPerfil.php"><button class="button is-block is-link is-fullwidth" style="margin-top: 4%; background-color: #28a745;">Voltar ao seu Perfil</button>
            </a>
          </div>
        </div>
      </div>
