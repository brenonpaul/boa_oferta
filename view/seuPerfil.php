		...
		<div class="row">
			<div class="col-3 row d-flex justify-content-center" id="caixaImgPerfil">
				...
				while($row_usuario = mysqli_fetch_assoc($resultado_usuario)){
					...
					<div id="middle">
						<a href="alterarInfo.php?info=1"> 
							<div id="textoImgPerfil">Alterar Foto</div>
						</a>
					</div>
					<div>
						<div class="mt-3 row justify-content-center">
							<a href="alterarInfo.php?info=4">
								<h6>Alterar Senha</h6>
							</a>
						</div>
				...
				<div class="col-1"></div>
				<div class="col-3 ">
					<h6 class="mb-4 mt-4"><strong>Apelido:</strong> 
				...
				?>
				<a href="alterarInfo.php?info=3"> 
					<img src="../imagens/editar.png" style="width: 10%;" id="imgEditar">
				</a>
			</div>
		</div>
