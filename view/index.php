        ...
        <div style="background-color: white;">
            <div class="container">
                ...
                <div v-if="produtos.length===0">
                    <h2 class="text-danger text-center mt-5">Ainda não existe nenhum produto cadastrado nesta categoria, que tal ser o primeiro?</h2>
                    <div class="row justify-content-center mt-4">
                        <a href="cadastroProduto.php"><button class="btn button-center" style="background-color: #a52a2a; color: white;">Cadastrar Produto</button></a>
                    </div>
                </div>
        ...
        <div style="background-color: white;">
            <div class="container">
                ...
                <div v-if="produtos.length===0">
                    ...
                    <div class="row justify-content-center mt-4">
                        <a href="telaLogin.php"><button class="btn button-center" style="background-color: #a52a2a; color: white;">Logar-se</button>
                        </a>
                    </div>
